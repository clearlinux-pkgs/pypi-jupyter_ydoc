...
Source0  : https://files.pythonhosted.org/packages/d8/15/472565b582c6eb4eb8febe1e86636e19127499daa98164aed292e00b8799/jupyter_ydoc-1.1.1.tar.gz
...
%prep
%setup -q -n jupyter_ydoc-1.1.1
cd %{_builddir}/jupyter_ydoc-1.1.1
pushd ..
cp -a jupyter_ydoc-1.1.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1695998516
