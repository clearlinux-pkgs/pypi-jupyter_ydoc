...
Version  : 3.0.5
Release  : 50
URL      : https://files.pythonhosted.org/packages/db/9f/eb56e55a4a1f0663ea4c1d53d9ac7c89a25b8179a3784287d0d5ea49dcfc/jupyter_ydoc-3.0.5.tar.gz
Source0  : https://files.pythonhosted.org/packages/db/9f/eb56e55a4a1f0663ea4c1d53d9ac7c89a25b8179a3784287d0d5ea49dcfc/jupyter_ydoc-3.0.5.tar.gz
...
%prep
%setup -q -n jupyter_ydoc-3.0.5
cd %{_builddir}/jupyter_ydoc-3.0.5
pushd ..
cp -a jupyter_ydoc-3.0.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746627534
