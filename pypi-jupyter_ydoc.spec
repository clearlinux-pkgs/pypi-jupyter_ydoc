...
Version  : 2.1.1
Release  : 40
URL      : https://files.pythonhosted.org/packages/fa/5d/369982304bf0c3af38463deabcae995a7b990b50be61896c64221d914a21/jupyter_ydoc-2.1.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/fa/5d/369982304bf0c3af38463deabcae995a7b990b50be61896c64221d914a21/jupyter_ydoc-2.1.1.tar.gz
...
%prep
%setup -q -n jupyter_ydoc-2.1.1
cd %{_builddir}/jupyter_ydoc-2.1.1
pushd ..
cp -a jupyter_ydoc-2.1.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720643366
